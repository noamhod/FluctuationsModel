...
pdf_arrx,pdf_arrsy = Mod.get_as_arrays(pdfs,Mod.scale)
cdf_arrx,cdf_arrsy = Mod.get_as_arrays(cdfs,Mod.scale)
...
if(Mod.IONB and not Mod.BEBL):
    ...
    cdfs["hBorysov_Ion"].Draw("hist same")
ROOT.gPad.RedrawAxis()
canvas.cd(2)
ROOT.gPad.SetTicks(1,1)
ROOT.gPad.SetGridx()
...
if(Mod.IONG and not Mod.BEBL): 
    ...
    cdfs["hTrncGaus_Ion"].Draw("hist same")
ROOT.gPad.RedrawAxis()
canvas.cd(5)
ROOT.gPad.SetTicks(1,1)
ROOT.gPad.SetGridx()
...
if(Mod.EX1G and not Mod.BEBL):
    ...
    cdfs["hTrncGaus_Exc"].Draw("hist same")
ROOT.gPad.RedrawAxis()
canvas.cd(6)
ROOT.gPad.SetTicks(1,1)
ROOT.gPad.SetGridx()
