...
# histos
# histos = {}
# histos.update({"hE":           TH1D("h_E",";E [MeV];Steps", 1000,2,100)})
...
# histos.update({"hdEdx_vs_E":   TH2D("h_dEdx_vs_E",";E [MeV];dE/dx [MeV/#mum];Steps",500,2,100, len(bins.dEdxbins)-1,array.array("d",bins.dEdxbins))})
...
# histos.update({"hdx_vs_E":     TH2D("h_dx_vs_E",";E [MeV];dx [#mum];Steps", 500,2,100, len(bins.dxbins)-1,array.array("d",bins.dxbins))})
# histos.update({"hdxinv_vs_E":  TH2D("h_dxinv_vs_E",";E [MeV];1/dx [1/#mum];Steps", 500,2,100, len(bins.dxinvbins)-1,array.array("d",bins.dxinvbins))})
#
